...
\item Die srs.db wurde um Gitterreferenzen erweitert.
...
\item Viele Verbesserungen und neue Operatoren wurden für den Feldrechner ergänzt, einschließlich Feldverkettung, Zeilenzähler etc.
...
\item WFS-T-Unterstützung ist nun vorhanden. Außerdem wurde WFS auf den Networkmanager portiert.
...
\item Die Werte in der Attributetabelle können jetzt sortiert werden (aufsteigend/absteigend nach mehreren Spalten).
\end{itemize}
