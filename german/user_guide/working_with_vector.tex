...
\subsection{MapInfo Layer laden}
...
dann nicht geändert werden. Dies ist nützlich, wenn man die Farbe eines 
...
\item \textbf{Colorbrewer}: Erstellen von Farbbereichen aus einem Farbschema und 
einer definierten Anzahl von Farbklassen.
\end{itemize}

Sie können neue Farbanstiege im Stilmanager definieren (siehe Kapitel 
\ref{subsec:stylemanager}), indem Sie auf \button{Element hinzufügen} klicken, 
...
veränderbaren Standard-Stil in QGIS und Sie können weitere Stile hinzufügen. 

\minisec{Darstellungen}

Über die Darstellung wird festgelegt, wie Objekte als Symbole angezeigt werden. 
Es gibt drei Arten der Darstellung: Einzelsymbol, Kategorisiert (in der alten 
