...
Werkzeugleiste\index{Shapedateien!Öffnen} oder mit der Taste \keystroke{V}.
Mit demselben Tool können Sie auch alle anderen durch OGR unterstützten
Formate laden.
...
\index{SpatiaLite layer!Layereigenschaften}
\index{Vektorlayer!SpatiaLite|siehe{SpatiaLite}}
...
\dropmenuopttwo{mActionOptions}{Optionen}). Im Reiter \tab{Digitalisierung} können Sie auswählen, ob
