...
Spalten für X- und Y-Koordinaten enthalten, als ein Layer in QGIS geladen werden.
...
vorhandener Plugins. Sie können das  Plugins mit den entsprechenden
Kontrollkästchen \checkbox{Getrennter Text} aktivieren und dann auf den Knopf 
...
richtige Trennzeichen zu wählen. Im unteren Feld wird nun der Inhalt korrekt
