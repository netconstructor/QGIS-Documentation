...
indem Sie das Programm \emph{In GPS hochladen} verwenden. Der Vektorlayer muss
dazu ein GPX-layer sein. Sie wählen dazu einen entsprechenden Layer aus, den Typ
