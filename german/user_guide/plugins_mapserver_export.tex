...
\subsection{MapServer Export Plugin}\label{sec:mapserver_export}\index{Plugins!MapServer Export}
...
Flashvideo von Christopher Schmidt an, auch wenn es auf einer älteren QGIS
Version basiert:
