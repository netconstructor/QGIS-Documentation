...
\subsection{Urheberrechtshinweis Plugin}\index{Plugins!Copyright}
...
\subsection{Nordpfeil Plugin}\index{Plugins!Nordpfeil}
...
\subsection{Maßstab Plugin}\index{Plugins!Maßstab}
