...
\includegraphics[width=0.6cm]{grid_maker}
 & Gradnetz Generator \index{Plugins!Gradnetz Generator} & Erstellt ein
Gradnetz als Lat/Lon und speichert es als Shapefile\\
\hline
...
\includegraphics[width=0.6cm]{ogr_converter}
 & OGR-Layer-Konverter \index{Plugins!OGR-Layer-Konverter} & Wandelt Vektorlayer
