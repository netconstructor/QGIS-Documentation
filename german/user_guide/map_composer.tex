...
Um den Print Composer zu benutzen, laden Sie zuerst die Ebenen, die Sie layouten
...
\includegraphics[width=0.7cm]{composer_add_map08} Um Ebenen im Kartenfenster des
...
Kartenfenster auf um die aktuell visualisierten Ebenen darzustellen. Sie können
...
Ebenen hinzufügen usw.) können Sie das Kartenfenster des Print Composers anpassen
...
hinzugefügt und die anzuzeigenden Vektorebenen ausgewählt werden. Um eine
