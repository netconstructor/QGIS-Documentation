\section{Module der GRASS Werkzeugkiste}\label{appdx_grass_toolbox_modules}
...
\subsection{GRASS Werkzeugkiste: Module für Daten Im- und Export}\index{GRASS!toolbox!modules}
...
\begin{table}[ht]
\centering
\caption{GRASS Werkzeugkiste: Module für den Datenimport}\medskip
 \begin{tabular}{|p{4cm}|p{12cm}|}
  \hline \multicolumn{2}{|c|}{\textbf{Module für den Datenimport}} \\ 
...
\begin{table}[ht]
\centering
\caption{GRASS Werkzeugkiste: Module für den Datenexport}\medskip
 \begin{tabular}{|p{4cm}|p{12cm}|}
  \hline \multicolumn{2}{|c|}{\textbf{Module für den Datenexport}} \\ 
  \hline \textbf{Modulname} & \textbf{Beschreibung} \\
  ...
  \hline r.gridatb & Exportiert GRASS Raster ins GRIDATB.FOR Format (TOPMODEL) \\
  ...
  \hline r.out.png & Exportiert GRASS Raster in ein nicht-georeferenziertes PNG \\
...
aktuellen Region-Einstellung\\
  ...
  \hline v.out.ogr.postgis & Exportiert GRASS Vektorlayer in eine PostGIS Datenbank \\
...
Regionausdehnung \\
  \hline v.in.db & Importiere Vectorpunkte aus einer Datenbanktabelle mit
Koordinaten \\
...
Attributspalte \\
  \hline v.report & Zeige statistische Informationen Geometrie eines
Vectorlayers \\
...
\caption{GRASS Werkzeugkiste: Module zur Bilddatenanalyse}\medskip
 \begin{tabular}{|p{4cm}|p{12cm}|}
  ...
  \hline \textbf{Modulname} & \textbf{Beschreibung} \\
  \hline i.image.mosaik & Mosaikiere bis zu 4 Bilder \\
