...
la couche et choisissez \dropmenuopt{Propriétés} du menu
...
% {\em NODATA}.
De plus, vous pouvez entrer une valeur raster qui pourra être traitée comme {\em
NODATA}
...
%  \dropmenuopt{Properties} from the popup meun.
 \item Ouvrez la boîte de dialogue \dialog{propriétés} en double-cliquant sur
...
symbole de la légende, et la palette.\index{couches raster!propriétés}
