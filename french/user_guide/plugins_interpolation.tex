...
\begin{enumerate}
  ...
  \item S\'electionnez \selectstring{Interpolation Triangulaire}{\ldots} comme m\'ethode d'interpolation, d\'efinissez 3663 colonnes et 1964 lignes (ce qui \'equivaut \`a une r\'esolution par pixel de 1000 m\`etres) et \filename{elevation\_tin} comme nom pour le fichier en sortie.
