...
Per selezionare uno strumento di misura cliccare su \includegraphics[width=0.7cm]{mActionMeasure} e scegliere lo strumento che si intende utilizzare.
...
\begin{description}
\item \includegraphics[width=0.5cm]{mActionSelect} Seleziona il singolo elemento
