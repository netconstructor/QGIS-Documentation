...
являются стандартными в среде KDE. В среде GNOME меню <<Установки>>
...
легенды используется для показа или сокрытия слоя.\index{layer!visibility}
...
\tab{Инструменты} и выберите нужный вам эллипсоид. На этой же вкладке же
