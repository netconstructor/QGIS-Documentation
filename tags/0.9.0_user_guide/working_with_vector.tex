...
The \textsl{Query Builder} button allows you to create a subset of the features 
...
To set the snap tolerance, choose \textsl{Project Properties} from the
...
Alternately, you can use the \index{Toggle Editing} \includegraphics[width=0.4cm, clip=true]{StartEditing} 
\textit{Toggle editing} button from the toolbar to start of stop the editing mode.\index{editing!icons}
...
vs. text). Make sure of this before pressing \textit{Ok}, otherwise you may find the error
