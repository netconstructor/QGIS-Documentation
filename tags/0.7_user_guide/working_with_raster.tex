...
\includegraphics[width=0.7cm]{addraster.eps}Raster layers
...
the file dialog.\index{rasters!loading}
...
items that allow you to:\index{rasters!context menu}

\begin{figure}[ht]
   \begin{center}
   \caption{Raster context menu}\label{fig:raster_contextmenu}\smallskip
   \includegraphics[clip=true, width=8cm]{rastercontextmenu.eps}
\end{center}  
\end{figure}
...
Dialog}\label{fig:raster_properties}\smallskip
   \includegraphics[clip=true, width=14cm]{raster_properties.eps}
\end{center}  
\end{figure}
...
can be used:\index{rasters!renderers}
...
levels.\index{rasters!transparency} Use the transparency slider to indicate to
...
layer.\index{rasters!standard deviation} This is useful when you have one or
...
and the palette.\index{rasters!properties}
