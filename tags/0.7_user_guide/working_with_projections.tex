...
the Well Known Text (WKT)\index{WKT} specification of the the coordinate
system. The
...
\qgistip{
If you open the \textit{Project Properties} dialog from the Settings menu, you
must
...
\begin{figure}[ht]
   ...
   \includegraphics[clip=true, width=14cm]{projectiondialog.eps}
\end{center}  
\end{figure}

\begin{enumerate}
\item Enable projections\index{Projections!enabling} - this checkbox is used
...
\subsubsection{Specifying a Projection}\index{Projections!specifying}
...
X)}\label{fig:customprojections}\smallskip
   \includegraphics[clip=true, width=14cm]{customprojection.eps}
\end{center}  
\end{figure}
...
(available at \url{ftp://ftp.remotesensing.org/proj/new\_docs/OF90-284.pdf}).
