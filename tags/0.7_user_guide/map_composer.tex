...
\begin{figure}[ht]
   ...
   \includegraphics[clip=true, width=\textwidth]{map_composer_blank.eps}
\end{center}  
\end{figure}
...
\includegraphics[width=0.7cm]{composer_add_map.eps} To add
...
\includegraphics[width=0.7cm]{composer_add_legend.eps} A
...
\includegraphics[width=0.7cm]{composer_add_scalebar.eps} To
...
\includegraphics[width=0.7cm]{composer_add_text.eps} You can
...
\begin{figure}[h]
   ...
   \includegraphics[clip=true, width=\textwidth]{map_composer.eps}
\end{center}  
\end{figure}
