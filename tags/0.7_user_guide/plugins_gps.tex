...
\includegraphics[width=0.7cm]{icon.eps} To load a GPX file you need to use the
\emph{GPS
...
\includegraphics[clip=true, width=12cm]{loadgpx.eps}
\end{center}
\end{figure}
...
tool}
\includegraphics[clip=true, width=12cm]{importdialog.eps}
   \end{center}
\end{figure}
...
\includegraphics[clip=true, width=14cm]{download.eps}
   \end{center}
\end{figure}
