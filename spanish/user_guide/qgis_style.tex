...
\usepackage[bookmarks=true, bookmarksnumbered=false, pdftitle={Documentaci\'on de QGIS}, pdfauthor={Proyecto QGIS}, pdfsubject={Guía de Usuario de QGIS}, breaklinks=true, colorlinks=false, linkcolor=black,dvips]{hyperref}
