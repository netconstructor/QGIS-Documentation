...
\section{Externe Python Plugins verwenden}\label{sec:external_plugins}\index{Plugins!Externe Plugins}
...
\minisec{Inoffizielles Python Plugin Repository}\index{Externes Plugin
Repository}
