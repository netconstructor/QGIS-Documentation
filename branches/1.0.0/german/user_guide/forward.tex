...
Kopie der Lizens ist dem Programm beigefügt und kann auch im Appendix
\ref{gpl_appendix} eingesehen werden.

\begin{Tip}\caption{\textsc{Aktuelle Dokumentation finden}}\index{documentation}
...
ist es möglich, druckfertige Karte zu layouten. Zu den zahlreichen
...
\item Überlagerung des Kartenfensters mit einem Gradnetz
...
exportieren zu können. QGIS bietet aktuell folgende Funktionalitäten:
...
Exportieren von GPX Daten auf ein GPS-Gerät.
\item Erstellen von PostGIS Layern aus ESRI Shapes mit dem SPIT Plugin
\item Verwaltung von Vektor-Attributtabellen mit dem Table Manager Plugin  
\end{itemize}
