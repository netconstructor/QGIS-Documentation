...
\dropmenuopt{Rinomina} dal menu contestuale.
...
spaziatrice}}\index{muovere la mappa!tasti freccia}
...
Può essere aggiunto un singolo layer alla panoramica facendo click col tasto destro su di esso nella legenda e scegliendo poi \checkbox{Aggiungi alla
panoramica}. Possono anche essere aggiunti o rimossi tutti i layer nella
...
metri nella scheda \tab{Generale} sotto il menu \mainmenuopt{Impostazioni}
...
\dialog{Opzioni} dialog. Selezionare la voce di menu \mainmenuopt{Impostazioni} >
...
\item \checkbox{Scelta del colore per evidenziare la selezione e lo sfondo
della vista mappa}
