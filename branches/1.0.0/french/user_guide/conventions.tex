...
\item Objet del bo\^ite d'outils: \toolboxtwo{nviz.1.eps}{nviz - Open 3D-View in NVIZ}
%
...
\item S\'election d'un chiffre a Number: \selectnumber{Halo}{60}
%
...
\item Non d'un fichier: \filename{lakes.shp}
...
\item Non d'une classe: \classname{NewLayer}
