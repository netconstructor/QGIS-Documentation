...
Vous pouvez créer, éditer, gérer et exporter des données vecteurs dans plusieurs formats. Les données raster doivent être importé dans GRASS pour pouvoir être édité et exporter dans d'autres formats. QGIS permet ce qui suit :  
