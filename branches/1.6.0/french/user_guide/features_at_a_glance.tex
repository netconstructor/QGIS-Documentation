...
La barre d'outils fournit plusieurs outils de sélection d'entités à partir du canevas de la carte. pour sléectionner une ou plusieurs entités, cliquez  sur \includegraphics[width=0.7cm]{mActionSelect}\footnote{Un clic plus long ou un clic sur la flèche noir pointée vers le bas suffiront.} et choisissez l'outil :
