...
la barre d'outils fournit plusieurs outils de sélection d'entités à partir du canevas de la carte. pour sléectionner une ou plusieurs entités, cliquez sur \includegraphics[width=0.7cm]{mActionSelect} et choisissez l'outil :
