...
\begin{description}
\item \radiobuttonon{{}Выбрать объекты}
\item \radiobuttonoff{{}Выбрать объекты прямоугольником}
\item \radiobuttonoff{{}Выбрать объекты полигоном}
\item \radiobuttonoff{{}Выбрать объекты произвольной линией}
\item \radiobuttonoff{{}Выбрать объекты в радиусе}
\end{description}
...
\subsection{Диалоговая аннтация}\index{аннотации}
