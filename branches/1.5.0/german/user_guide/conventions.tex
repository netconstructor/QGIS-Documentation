...
\item Menü Optionen: \mainmenuopt{Layer} \arrow
...
\item Werkzeugbox : \toolboxtwo{nviz}{nviz - Öffne 3D-Ansicht in NVIZ} 
\item Kontrollkästchen: \checkbox{Darstellen}
\item Radioknopf:  \radiobuttonon{Postgis SRID} \radiobuttonoff{EPSG ID}
\item Wähle eine Zahl: \selectnumber{Sättigung}{60}
\item Wähle ein Wort: \selectstring{Umrandungsoption}{--- durchgängig}
\item Suche nach einer Datei: \browsebutton 
\item Wähle eine Farbe: \selectcolor{Umrandungsfarbe}{yellow}
...
\button{Beenden}, um QGIS zu schließen. Dieses Kommando bedeutet: QGIS wird unter
