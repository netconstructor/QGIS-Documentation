...
\item Das \toolbtntwo{quick_print}{Schnelles Drucken} Plugin, zum Erstellen 
einfacher Karten (siehe Kapitel \ref{quickprint}). 
\end{itemize}
...
\minisec{Beschriftungsformular}\index{Beschriftung}
...
Auch wenn Sie das Kontrollkästchen \checkbox{Stützpunkte automatisch 
hinzufügen} nicht aktiviert haben und einzelne Stützpunkte manuell 
