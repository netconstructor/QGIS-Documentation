...
На дату составления настоящего документа библиотекой OGR
...
\index{raster layers!supported formats} \index{GDAL!supported
formats}

На дату составления настоящего документа библиотекой GDAL
...
\item GRASS Rasters \footnote{Поддержка GRASS обеспечивается расширением
Провайдер данных QGIS GRASS}
