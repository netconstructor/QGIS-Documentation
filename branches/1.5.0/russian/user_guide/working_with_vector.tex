...
с помощью дополнительных модулей.\index{текст с разделителями}
...
\subsection{Создание новых слоёв в формате Shape и Spatialite}\label{sec:create shape}\index{редактирование!создание нового слоя}
...
\minisec{Создание нового  shape-слоя}\label{sec:create shape}\index{редактирование!создание нового shape-файла}
