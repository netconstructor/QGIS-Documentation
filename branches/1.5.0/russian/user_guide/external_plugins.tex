...
\chapter{Использование внешних Python расширений}\label{sec:external_plugins}\index{plugins}
...
Установщик модулей (\mainmenuopt{Модули} \arrow \dropmenuopttwo{plugin_installer}{Загрузить модули...}),
перейдите на вкладку \tab{Репозитории} и нажмите \button{Добавить сторонние репозитории}.
Если некоторые из добавленных репозиториев вам не нужны, они могут быть отключены кнопкой
\button{Изменить...}, или полностью удалены нажатием на кнопку \button{Удалить}.
\end{Tip}
\FloatBarrier
