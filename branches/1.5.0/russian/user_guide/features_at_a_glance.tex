...
QGIS набрав в командной строке: \usertext{qgis} или двойным нажатием на
ссылке (или ярлыке) QGIS на Рабочем Столе или в меню Приложения.}
...
\usertext{qgis ---help}. В результате мы получим:
...
\usertext{---width} и \usertext{---height}. Имя файла задается после
\usertext{---snapshot}.
...
Также возможно запустить QGIS с существующим файлом проекта. Просто
добавьте параметр \usertext{---project} после имени проекта и QGIS
...
После активации \toolbtntwo{mActionToggleEditing}{Режим редактирования}
...
\textbf{Примечание:} \nix Пункты панели меню, перечисленные выше,
являются стандартными для менеджера окон в KDE. В GNOME, меню Установки
отсутствует, а его пункты расположены следующим образом:
\begin{tabbing}
...
\dropmenuopt{Добавить группу}. Появится новая папка. Теперь, перетащите
...
\dropmenuopt{Сделать элементом первого уровня}. Чтобы переименовать
папку, выберите \dropmenuopt{Переименовать}, нажав правой кнопкой на
имени группы.
...
\dropmenuopt{Добавить группу}. Появится файл группы слоев. Стало
...
можно настроить по своему вкусу, используя вкладку \tab{Инструменты} в
...
Добавить в Обзор единичный слой можно, нажав правой кнопкой мыши на этом
...
\arrow \dropmenuopt{Свойства проекта}, либо можно выбрать систему
...
Дополнительно, пункт меню \mainmenuopt{Установки} \arrow
\dropmenuopt{Комбинации клавиш} позволяет изменять комбинации клавиш
...
дважды нажав на слое в легенде. На вкладке \tab{Общие}, нажмите флажок \\
...
вы хотите использовать, отмечая значение масштаба в строке состояния QGIS.\index{scale}
...
Для приостановки отрисовки карты, включите флажок \checkbox{Отрисовка}
...
Включение флажка \checkbox{Отрисовка} активирует рендеринг и немедленно
...
из хранилища данных,выберите пункт меню \mainmenuopt{Установки} \arrow
\dropmenuopt{Параметры}, нажмите на вкладке \tab{Отрисовка}. Установите
...
меню \mainmenuopt{Установки} \arrow \dropmenuopt{Параметры}, нажмите
на вкладке \tab{Инструменты} и выберите соответствующий эллипсоид. Там
...
Если вы хотите очистить вашу сессию и начать новую, выберите \mainmenuopt{Файл}
...
\begin{itemize}
\item Пункт меню \dropmenuopttwo{mActionSaveMapAsImage}{Сохранить как изображение...}
...
\dropmenuopttwo{mActionOptions}{Параметры}. Параметры можно задать на
следующих вкладках:
...
\item \checkbox{Create raster icons in legend (Создавать превью в легенде
для растровых слоев)}
...
закладку нажав на ней, затем нажмите кнопку \button{Увеличить до}. Также
...
выберите ее и нажмите кнопку \button{Удалить}. Подтвердите ваш выбор
...
\arrow \dropmenuopt{GPS-слежение}. Появится новое пристыкованное окно
