...
\subsection{Interpolationsplugin}\index{Plugins!Interpolation}
...
Linien und Polygone als Randbedingungen für die Triangulation zu verwenden,
indem Sie im Dropdown-Menü ``Typ'' des geladenen Layers entweder
Strukturlinien oder Bruchkanten auswählen.
...
Interpolationsmethode, definieren Sie als Zellengröße in X- und Y-Richtung 
5000. Als Ausgabedatei geben Sie \filename{elevation\_tin} an.
