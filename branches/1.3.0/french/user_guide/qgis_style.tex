...
\usepackage[bookmarks=true, bookmarksnumbered=false, pdftitle={Documentation de QGIS}, pdfauthor={Projet QGIS}, pdfsubject={Guide utilisateur de QGIS}, breaklinks=true, colorlinks=false, linkcolor=black,dvips]{hyperref}
